...
namespace Microsoft.MixedReality.Toolkit.Experimental.UI
{
    ...
    /// <seealso cref="NoRotationDockPosition"/>
    [AddComponentMenu("Scripts/NoRotationDock")]
    public class NoRotationDock : MonoBehaviour
    {
        /// <summary>
        ...
        private ReadOnlyCollection<NoRotationDockPosition> dockPositions;      
        ...
        /// A read-only list of possible positions in this dock.
        /// </summary>
        public ReadOnlyCollection<NoRotationDockPosition> DockPositions => dockPositions;
        ...
        {
            dockPositions = gameObject.GetComponentsInChildren<NoRotationDockPosition>().ToReadOnlyCollection();
        }
        ...
        public bool TryMoveToFreeSpace(NoRotationDockPosition position)
        {
            ...
            {
                Debug.LogError("Looking for a NoRotationDockPosition in the wrong Dock.");
                return false;
            }
